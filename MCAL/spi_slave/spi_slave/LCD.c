...
void LCD_vdClear(){
	LCD_vdSendCom(CLEAR_HOME);
		/*LCD_vdSendCom(0x40);       //Load the location where we want to store
		LCD_vdWriteChar(0x04);      //Load row 1 data
		LCD_vdWriteChar(0x0E);      //Load row 2 data
		LCD_vdWriteChar(0x0E);      //Load row 3 data
		LCD_vdWriteChar(0x0E);      //Load row 4 data
		LCD_vdWriteChar(0x1F);      //Load row 5 data
		LCD_vdWriteChar(0x00);      //Load row 6 data
		LCD_vdWriteChar(0x04);      //Load row 7 data
		LCD_vdWriteChar(0x00);      //Load row 8 data
		LCD_vdWriteChar(0);
		LCD_vdWriteChar('A');*/
